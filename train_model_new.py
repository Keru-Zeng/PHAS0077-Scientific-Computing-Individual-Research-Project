...
for id_ in tqdm(train_ids, total=len(train_ids)):
    ...
    for i in range(0,k): 
        ...
        masks = resize(masks, (img_height, img_width, 1), mode='constant', preserve_range=True)
        Y_train[n] = masks
        n+=1
...
results = model.fit_generator(train_generator, validation_data=vali_generator, validation_steps=10, steps_per_epoch=100,
